    ...
    return {
        embeddedApp: {
            on: function (b, c) {
                ...
                if (!h) {
                    ...
                    c.OnLoad(function () {
                        c.getContext().Event.Trigger("ZDK_EVENT", {action: "get_zdk_url"}, !0).then(function (k) {
                            self._zdksdk = c;
        ...
        CRM: function () {
            ...
            function p(a, d, e) {
                ...
                if (e) f = d; else {
                    var f = d.url,
                        c = d.params, g = d.headers, k = d.body, h = d.PARTS, m = d.PART_BOUNDARY, w = d.CONTENT_TYPE,
                        D = d.RESPONSE_TYPE;
                    d = d.FILE;
                    if (!f) throw{Message: "Url missing"};
                    if (c) {
                        var x, l = [];
                        for (x in c) l.push(encodeURIComponent(x) + "\x3d" + encodeURIComponent(c[x]));
                        x = l.join("\x26");
                        f += (-1 < f.indexOf("?") ? "\x26" : "?") + x
                    }
                    f = {
            ...
            function r(a, d, e) {
                return b({
                    category: "CONFIG",
                    type: a, nameSpace: d, APIData: e
                })
            }

            function u(a) {
                var d = {category: "USER"};
                a.ID ? d.ID = a.ID : a.Type && (d.Type = a.Type, a.page && (d.page = a.page), a.per_page && (d.per_page = a.per_page));
                return b(d)
            }
            ...
            return {
                ACTION: {
                    ...
                    coql: function (a) {
                        ...
                        var b = {};
                        a ? a.action = "GET_APPROVAL_RECORDS" : (b.action = "GET_APPROVAL_RECORDS", a = b);
                        return h(a)
...
var ZSDKUtil = function (c) {
    ...
    function h(b) {
        ...
        b.substr(b.indexOf("?") + 1).split("\x26").forEach(function (b, n) {
            var h = b.split("\x3d");
            c[h[0]] = h[1]
        });
    ...
    function m(e) {
        ...
        var l = f.type, m = f.eventName;
        try {
            var k;
            if (!(k = "SET_CONTEXT" === m)) {
                var p = e.source,
                    q = e.origin;
                k = g.isAppRegistered() && a === p && d === q ? !0 : Error("Un-Authorized Message.")
            }
            if (k) switch (l) {
                case "FRAMEWORK.EVENT":
                    ...
                    w && "function" === typeof w ? w(e, f) : ZSDKEventManager.NotifyEventListeners(g.AppContext, f.eventName, f.data);
                    break;
                default:
    ...
    function k(a, b, c) {
        l.hasOwnProperty(a) && (b ? l[a].resolve(c) : l[a].reject(c), l[a] = void 0, delete l[a])
    }
    ...
    var g, r = ZSDKUtil.getLogger(), u = 100, l = {}, a, d;
    c.Init = function (a, b) {
    ...
    c.DERegisterApp = function () {
        var a = {
            type: "SDK.EVENT",
            eventName: "DEREGISTER", uniqueID: g.getUniqueID()
        };
        v(a)
    };
    ...
    c.TriggerEvent = function (a, b, c) {
        ...
        a = {
            type: "SDK.EVENT", eventName: a, uniqueID: g.getUniqueID(), time: (new Date).getTime(), promiseid: d,
            data: b
        };
        v(a);
        if (c) return y(d)
    ...
    return c
}(window.ZSDKMessageManager || {}), ZSDKEventManager = function (c) {
    var m = ZSDKUtil.getLogger(), h = {};
    ...
    c.NotifyEventListeners = function (c, b, t) {
        ...
        Array.isArray(k);
        if ((k = h[b]) && Array.isArray(k)) for (b = 0; b < k.length; b++) k[b].call(c, t); else m.Info("Cannot find EventListeners for Event : ", b)
    };
...
function ZSDK() {
    function c() {
        "function" !== typeof l ? z.Error("No OnLoad Handler provided to execute.") : C ? z.Error("OnLoad event already triggered.") : (l.call(q, q), C = !0)
    }
    ...
    function r(a, b) {
        ...
        for (var c = b.split("."), d = 0, e = c.length; d < e; ++d) {
            var f = c[d];
            if (f in a) a = a[f]; else return
        }
        return a
    }

    function u() {
        var a = document.querySelectorAll("[data-i18n]"), b;
    ...
    var l, a, d, e, f, A = {}, z = ZSDKUtil.getLogger(), B = !1, C = !1;
