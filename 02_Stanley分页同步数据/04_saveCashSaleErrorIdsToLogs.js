void automation.saveCashSaleErrorIdsToLogs(String error400IdsStr,Int error400IdsCount,Int startOffset,Int finalProcessed,Int totalSuccess,Int totalFailed)
{
// 构建错误记录内容
errorData = Map();
...
// 创建错误记录
noteParams = Map();
noteParams.put("Name","CashSaleSync_400Errors_" + startOffset + "_" + finalProcessed);
