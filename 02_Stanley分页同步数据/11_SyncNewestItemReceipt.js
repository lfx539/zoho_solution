void schedule.SyncNewestItemReceipt()
{
...
statusNotes = zoho.crm.searchRecords("vendorLogs","(Name:equals:ItemReceiptSyncStatus)");
...
info "开始同步最新ItemReceipts，fromDate = " + fromDate;
try
{
	allItems = List();
	offset = 0;
	...
	if(allItems == null || allItems.size() == 0)
	{
		...
		info "ItemReceiptSyncStatus 已更新，lastSyncDate = " + todayStr;
		return;
	}
	info "共获取 " + allItems.size() + " 条ItemReceipt，开始逐条同步";
